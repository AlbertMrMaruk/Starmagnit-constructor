...
const products = [
  {
    id: 0,
    url: "https://starmagnit.ru/magnity-standartnoy-formy.php",
    name: "Магниты на заказ",
    width: "80%",
    height: "85%",
    ...
    contHeight: "300",
    razmers: [
      { text: "50x50мм", width: 300, height: 300 },
      { text: "50x70мм", width: 300, height: 420 },
      { text: "50x85мм", width: 300, height: 510 },
      { text: "50x90мм", width: 300, height: 540 },
      { text: "70x100мм", width: 420, height: 600 },
    ],
